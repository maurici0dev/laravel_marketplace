...
<form action="{{ route('admin.stores.update', ['store' => $store->id]) }}" method="post">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" id="description" name="description" value="{{ $store->description }}" class="form-control">
    </div>
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" id="mobile_phone" name="mobile_phone" value="{{ $store->mobile_phone }}" class="form-control">
    </div>
